...
class BalancePinPage extends StatefulWidget {
  const BalancePinPage({
    Key? key,
  }) : super(key: key);

  @override
  _BalancePinPageState createState() => _BalancePinPageState();
}

class _BalancePinPageState extends State<BalancePinPage> {
  var selectedindex = 0;
  String code = '';
